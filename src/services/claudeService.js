...
- セキュリティ警告・注意喚起メール（「パスワード変更を推奨」「不審メールに注意」「不正利用に注意」など）
- 銀行・サービスからの一般的なお知らせ・推奨事項（「〇〇をご利用ください」「設定をお勧めします」など）
- フィッシング詐欺注意・セキュリティ情報メール

【タスクとして抽出してよいもの】（これ以外は抽出しない）：
- 予約確認・フライト・バス・ホテルなど日程が明確に書かれているもの
- 「〇〇までに提出してください」「〇〇を返送してください」など、相手から明確に求められている行動
- 支払い・解約・手続きの締め切りが具体的に書かれているもの
- 荷物の受け取り（配達日が指定されているもの）
- 会議・打ち合わせ・イベントの参加（日時が明確なもの）
