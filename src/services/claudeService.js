...
- レンタカーの予約 → タイトル例：「石垣島 レンタカー出発」、日付は出発日時
- ホテル・宿泊の予約 → タイトル例：「〇〇 チェックイン」、日付はチェックイン日
- 荷物の受け取り → タイトル例：「ヤマト便 受け取り」、日付は配達日
- 支払い・手続き → タイトル例：「〇〇の支払い期限」、日付は締め切り日
- その他 → 件名から具体的なタイトルをつける

日付は「〇月〇日」「〇年〇月〇日」と書かれている通りにYYYY-MM-DD形式に変換する（例：2026年06月15日 → 2026-06-15）。
時刻は「〇時〇分」「〇時」「午前〇時」「午後〇時」「〇:〇〇」をHH:MM形式に変換する（例：11時30分 → 11:30、14時 → 14:00、午後2時 → 14:00、9:00 → 09:00）。分の指定がない場合は00分とする。
メール内に「出発日時」「チェックイン日」「配達日」「返却日時」などが明記されている場合は必ず日付を設定する。
